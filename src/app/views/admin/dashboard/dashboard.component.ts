...
export class AdminDashboardComponent implements OnInit {
    ...
    @ViewChild('multRef') multiplierRef: ElementRef;
    @ViewChild('decayRef') decayRef: ElementRef;
    @ViewChild('reqChartCard') reqChartCard: ElementRef;
    @ViewChild('invChartCard') invChartCard: ElementRef;
    @ViewChild('reqChart') reqChart: RequestChartComponent;
    @ViewChild('invChart') invChart: InventoryChartComponent;
